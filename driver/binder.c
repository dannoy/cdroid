...
static long binder_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    pr_info("ioctl %lx BINDER_WRITE_READ		\n", BINDER_WRITE_READ		);
    pr_info("ioctl %lx BINDER_SET_IDLE_TIMEOUT		\n", BINDER_SET_IDLE_TIMEOUT		);
    pr_info("ioctl %lx BINDER_SET_MAX_THREADS		\n", BINDER_SET_MAX_THREADS		);
    pr_info("ioctl %lx BINDER_SET_IDLE_PRIORITY	\n", BINDER_SET_IDLE_PRIORITY	);
    pr_info("ioctl %lx BINDER_SET_CONTEXT_MGR		\n", BINDER_SET_CONTEXT_MGR		);
    pr_info("ioctl %lx BINDER_THREAD_EXIT		\n", BINDER_THREAD_EXIT		);
    pr_info("ioctl %lx BINDER_VERSION			\n", BINDER_VERSION			);
