...
void
jset_import_paths(const vector<string>& importPaths)
{
    g_importPaths = importPaths;
}

char*
jfind_import_file(const char* given)
{
...
jcompile_aidl(Options& options)
{
    ...
    jset_import_paths(options.importPaths);
...
int
jpreprocess_aidl(const Options& options)
{
    vector<string> lines;
    int err;
