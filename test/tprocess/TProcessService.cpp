...
namespace com {
    namespace routon {
        namespace os {
            ...
            {
                android::defaultServiceManager()->addService(android::String16("tprocess"), new TProcessService());
            }
...
err0:
            ...
            int TProcessService::tprocess_exec(String8& cmdStr, int redirectStderrToStdout,
                    int *rc, char **out, char **err) {
                String8 str8(cmdStr);
            ...
            android::sp<TResult> TProcessService::exec(String8& cmd, bool redirectStderrToStdout) {
                ...
                android::sp<TResult> tRes = new TResult(rc,
                        this_stdout ? String8(this_stdout) : String8(),
                        this_stderr ? String8(this_stderr) : String8());
